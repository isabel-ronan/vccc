  ...
  return (
    <section className="section">
      ...
      <Reveal dir="right" delay={3} style={{ marginTop: '1%', display: 'flex', flexFlow: 'row wrap', alignItems: 'stretch', justifyContent: 'center' }}>
        <div className="card" style={{ display: 'flex', flexFlow: 'column wrap', alignItems: 'stretch', justifyContent: 'center', flex: 1, height: '45vh', minWidth: '500px' }}>
      ...
      <Reveal dir="left" delay={3} style={{ marginTop: '1%', display: 'flex', flexFlow: 'row wrap', alignItems: 'stretch', justifyContent: 'center' }}>
        <div className="card" style={{ display: 'flex', flexFlow: 'column wrap', alignItems: 'center', justifyContent: 'center', flex: 1, height: '45vh', minWidth: '500px' }}>
          <img width="80%" height="100%" src={`${base}/images/hospitalSeekingSupport.jpg`}/>
        </div>
        <div className="card" style={{ display: 'flex', flexFlow: 'column wrap', alignItems: 'stretch', justifyContent: 'center', flex: 1, height: '45vh', minWidth: '500px' }}>
        ...
        <div className="card" style={{ display: 'flex', flexFlow: 'column wrap', alignItems: 'stretch', justifyContent: 'center', flex: 1, height: '45vh', minWidth: '500px' }}>
          ...
          <p>Phẫu thuật được sử dụng để ngăn ngừa, chẩn đoán, giai đoạn và điều trị ung thư. Phẫu thuật cũng có thể làm giảm sự khó chịu hoặc các vấn đề liên quan đến ung thư.</p></div>
        <div className="card" style={{ display: 'flex', flexFlow: 'column wrap', alignItems: 'stretch', justifyContent: 'center', flex: 1, height: '45vh', minWidth: '500px' }}>
